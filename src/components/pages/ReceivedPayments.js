...
function ReceivedPayments(){
    ...
    //update button in received due payments (put a tick in  collected column in due payments)
    const updateDue=(id)=>{
    ...
    //update button in received overdue payments (put a tick in  collected column in overdue payments)
